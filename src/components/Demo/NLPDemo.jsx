    ...
    return (
        <div className="nlp-demo-container">
            <div className="demo-header">
                ...
                <p>Experience our enhanced natural language processing capabilities with context awareness, sentiment analysis, and intelligent intent recognition.</p>
            </div>
            ...
            <div className="demo-tabs">
                ...
                <button 
                    className={`tab-button ${selectedDemo === 'analyzer' ? 'active' : ''}`}
                    onClick={() => setSelectedDemo('analyzer')}
                >
                    Message Analyzer
                </button>
                <button 
                    className={`tab-button ${selectedDemo === 'features' ? 'active' : ''}`}
                ...
                {selectedDemo === 'chat' && (
                    <div className="chat-demo">
                        <div className="demo-instructions">
                            ...
                            <p>Enable debug mode to see detailed NLP analysis including intent confidence, sentiment, and extracted entities.</p>
                ...
                {selectedDemo === 'analyzer' && (
                    <div className="analyzer-demo">
                        <div className="analyzer-section">
                            ...
                            <p>Test individual messages to see how our NLP engine processes them.</p>
                                        ...
                                        <div className="result-grid">
                                            <div className="result-card">
                                                ...
                                                <div className="intent-result">
                                                    <span className="intent-name">{analysisResult.intent}</span>
                                                    <span 
                                            ...
                                            <div className="result-card">
                                                ...
                                                <div 
                                                    ...
                                                    style={{ color: getSentimentColor(analysisResult.sentiment) }}
                                                >
                                            ...
                                            <div className="result-card">
                                                ...
                                                <div className="intent-scores">
                                                    {Object.entries(analysisResult.intentConfidences || {})
                                                        .sort(([,a], [,b]) => b - a)
                                                        .slice(0, 5)
                                            ...
                                            {analysisResult.requiresHumanHandoff && (
                                                <div className="result-card handoff-card">
                                                    ...
                                                    <p>This message requires human intervention due to complexity, low confidence, or sensitive nature.</p>
                                                </div>
                                            )}
                    ...
                    <div className="features-demo">
                        ...
                        <div className="features-grid">
                            <div className="feature-card">
                                ...
                                <p>Weighted keyword matching with context awareness for more accurate intent classification.</p>
                                <ul>
                            ...
                            <div className="feature-card">
                                ...
                                <p>Comprehensive entity recognition for automotive service scenarios.</p>
                                <ul>
                            ...
                            <div className="feature-card">
                                ...
                                <p>Real-time emotion detection to provide appropriate responses.</p>
                                <ul>
                            ...
                            <div className="feature-card">
                                ...
                                <p>Maintains conversation state for personalized interactions.</p>
                                <ul>
                            ...
                            <div className="feature-card">
                                ...
                                <p>Automatic correction of common automotive terminology misspellings.</p>
                                <ul>
                            ...
                            <div className="feature-card">
                                <h4>🤝 Smart Handoff</h4>
                                <p>Intelligent detection of when human intervention is needed.</p>
                                <ul>
